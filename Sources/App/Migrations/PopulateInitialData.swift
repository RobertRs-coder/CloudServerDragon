...
struct PopulateInitialData: AsyncMigration {
    ...
    func prepare(on database: Database) async throws {
        ...
        // MARK: - Characters
        let chiChi = Character(name: "Chi-Chi")
        let goku = Character(name: "Goku")
        let granjero = Character(name: "Granjero")
        let raditz = Character(name: "Raditz")
        let gohan = Character(name: "Gohan")
        let piccolo = Character(name: "Piccolo")
        let milk = Character(name: "Milk")
        let krilin = Character(name: "Krilin")
        
        //        try await [chiChi, goku, granjero].create(on: database)
